// In classical inheritance, we define a constructor that acts as a blueprint for any child objects.
// These child objects will have access to the constructor's methods and properties through the prototype chain. 
// Child objects are not copies of the parent, but rather are an abstraction of the original constructor. 
// This can create tight coupling and is generally inflexible.

// Use the class keyword to create the constructor
class Vehicle {
    // We will pass arguments to the constructor function within the class
    constructor(year, make, model) {
        // Set the initial object properties that will be accessible to all of the constructor's children
        this._year = year;
        this._make = make;
        this._model = model;
    }
